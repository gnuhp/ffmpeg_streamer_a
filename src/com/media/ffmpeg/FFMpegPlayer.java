...
public class FFMpegPlayer
{
    ...
    public FFMpegPlayer() {
        ...
        //Initializ a 16k audio-buff : this is to transfer audio data bw native and java
    ...
    */
    ...
    {
    	Log.d(TAG, "Start pcm player with: sample: "+ sampleRate + " channel:" + channels);
    	//_pcmPlayer = new PCMPlayer(11025, AudioFormat.CHANNEL_CONFIGURATION_MONO);
    	_pcmPlayer = new PCMPlayer(sampleRate, channels);
    ...
    {
    	if (pcmPlayer_thrd != null && pcmPlayer_thrd.isAlive())
    	{
    		_pcmPlayer.stop();
    		try
    		{
    ...
    /**
     * =======PCM ===
     * Process @len data in audio buff. 
     * Starting from index 0 -to- len-1
     * @param len
     * @return
     */
