...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --prefix=./android/armeabi --enable-cross-compile --enable-version3 --enable-gpl --enable-memalign-hack --enable-asm --extra-libs=-lgcc --arch=arm --cc=/home/phung/android-ndk-r7c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc --cross-prefix=/home/phung/android-ndk-r7c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi- --nm=/home/phung/android-ndk-r7c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-nm --sysroot=/home/phung/android-ndk-r7c/platforms/android-8/arch-arm/ --extra-cflags=' -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums  -fno-strict-aliasing -finline-limit=300 -I../x264/android/armeabi/include  ' --disable-shared --enable-static --enable-runtime-cpudetect --extra-ldflags='-Wl,-rpath-link=/home/phung/android-ndk-r7c/platforms/android-8/arch-arm//usr/lib -L/home/phung/android-ndk-r7c/platforms/android-8/arch-arm//usr/lib -L../x264/android/armeabi/lib -nostdlib -lc -lm -ldl -llog' --disable-everything --enable-demuxer=h264 --enable-demuxer=flv --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-demuxer=mpegtsraw --enable-demuxer=pcm_s16le --enable-muxer=flv --enable-muxer=pcm_s16le --enable-protocol=file --enable-protocol=applehttp --enable-protocol=http --enable-protocol=rtmp --enable-protocol=rtmpt --enable-protocol=rtmpe --enable-protocol=rtmpte --enable-protocol=rtmps --enable-protocol=rtp --enable-protocol=rtsp --enable-protocol=tcp --enable-protocol=udp --enable-avformat --enable-avcodec --enable-decoder=imc --enable-decoder=mpeg4 --enable-decoder=mpeg --enable-encoder=h264 --enable-decoder=h264 --enable-encoder=flv --enable-decoder=flv --enable-decoder=adpcm_swf --enable-decoder=adpcm_ms --enable-decoder=adpcm_ima_wav --enable-decoder=adpcm_ima_qt --enable-decoder=adpcm_yamaha --enable-encoder=adpcm_swf --enable-encoder=adpcm_ms --enable-encoder=adpcm_ima_wav --enable-encoder=adpcm_ima_qt --enable-encoder=adpcm_yamaha --enable-encoder=pcm_s16le --enable-decoder=pcm_s16le --enable-decoder=pcm_s16le_planar --enable-parser=h264 --enable-parser=mpeg4video --enable-parser=mpegaudio --enable-parser=mpegvideo --enable-muxer=ffm --enable-demuxer=ffm --enable-muxer=rtp --enable-demuxer=rtp --enable-decoder=rtp --enable-muxer=rtsp --enable-demuxer=rtsp --enable-libx264 --enable-encoder=libx264 --enable-decoder=amrnb --enable-decoder=amrwb
...
ARCH=arm
CC=/home/phung/android-ndk-r7c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
CXX=/home/phung/android-ndk-r7c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-g++
AS=/home/phung/android-ndk-r7c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
LD=/home/phung/android-ndk-r7c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
DEPCC=/home/phung/android-ndk-r7c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
YASM=yasm
YASMDEP=yasm
AR=/home/phung/android-ndk-r7c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-ar
RANLIB=/home/phung/android-ndk-r7c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=/home/phung/android-ndk-r7c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-strip
CPPFLAGS= --sysroot=/home/phung/android-ndk-r7c/platforms/android-8/arch-arm/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC
CFLAGS= -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -I../x264/android/armeabi/include  -std=c99 -fomit-frame-pointer -fPIC -marm -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS= -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -I../x264/android/armeabi/include  -fPIC -g
AS_O=-o $@
CC_O=-o $@
CXX_O=-o $@
LDFLAGS= -Wl,-rpath-link=/home/phung/android-ndk-r7c/platforms/android-8/arch-arm//usr/lib -L/home/phung/android-ndk-r7c/platforms/android-8/arch-arm//usr/lib -L../x264/android/armeabi/lib -nostdlib -lc -lm -ldl -llog --sysroot=/home/phung/android-ndk-r7c/platforms/android-8/arch-arm/ -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
...
ACODEC_TESTS=adpcm_adx adpcm_ima_qt adpcm_ima_wav adpcm_ms adpcm_swf adpcm_yam aref g722 g723_1 pcm_alaw pcm_f32be pcm_f32le pcm_f64be pcm_f64le pcm_mulaw pcm_s16be pcm_s16le pcm_s24be pcm_s24daud pcm_s24le pcm_s32be pcm_s32le pcm_s8 pcm_u8 
VCODEC_TESTS=amv cljr dnxhd_720p_10bit flashsv2 flv h263 h263p jpeg2000 mpng msvideo1 prores qtrle qtrlegray v210 vref zlib zmbv 
LAVF_TESTS=caf dpx ffm flv_fmt rso sox voc_s16 wtv 
